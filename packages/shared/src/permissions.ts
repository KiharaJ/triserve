...
export const PERMISSIONS = {
  jobs: [
    ...
    "job.qc.record",
    "job.qc.approve",
    // The bench parts loop: a technician asks for a part, stores raises it for
    // approval, and a manager signs it off. Deliberately its OWN permission
    // rather than the generic 'approval.decide' — the people who sign off a
    // part off the shelf are not necessarily the people who approve refunds
    // and purchase orders.
    "job.parts.approve",
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  "job.parts.approve": "Approve a parts issue request",
